...
-(void)ForImageUploding_runApiSuccessCallback:(SEL)successSelectorfailSelector inDelegate:delegateObj WithImageParameter:(NSMutableDictionary *)Iparameter WithoutImageParameter:(NSMutableDictionary *)WIparameter strImageParameter:(NSString *)strImageParameter;
